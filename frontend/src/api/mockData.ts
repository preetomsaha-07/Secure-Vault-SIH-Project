...
export const MOCK_DOCUMENT_VERSIONS: Record<string, DocumentVersion[]> = {
  doc_fir_104: [
    {
      id: 'ver_104_3',
      document_id: 'doc_fir_104',
      ...
      sha256_hash: '3a7bd3e2360a3d29eea436fcfb7e44c735d117c42d1c1835420b6b9942dd4f1b',
      file_size: 1048576,
      created_by: 'user_inv_a',
      created_by_name: 'Inspector Preetom Saha',
      badge_number: 'SV-CYBER-704',
      change_summary: 'Added judicial filing annexure with HSRP cloning forensic photo index & chassis stamp logs.',
    ...
    },
    {
      ...
      document_id: 'doc_fir_104',
      version_number: 2,
      sha256_hash: '8f1c4e92a7b3d16e0c5b8a92d4f3e71029c8a1b5d6e4f3a2c1b9e8d7c6b5a4f3',
      file_size: 980224,
      created_by: 'user_inv_a',
      created_by_name: 'Inspector Preetom Saha',
      badge_number: 'SV-CYBER-704',
      change_summary: 'Updated co-accused Vikram Solanki particulars and added Section 340(2) BNS forgery provisions.',
    ...
    },
    {
      ...
      document_id: 'doc_fir_104',
      version_number: 1,
      sha256_hash: '7d2e8a1b4c9f3e0d8a5c2b1e7f6a9d3c8b4e1a5f9c0d2e8a7b1c4d9e6f3a2b1c',
      file_size: 892400,
      created_by: 'user_admin',
      created_by_name: 'Dr. Vikramaditya Sen, IPS',
      badge_number: 'IPS-2011-DL04',
      change_summary: 'Initial First Information Report lodged at P.S. Cyber Crime following RTO alert.',
      created_at: '2024-08-14T12:00:00Z',
      is_current: false,
    },
  ],
  doc_rep_104: [
    {
      id: 'ver_rep_2',
      document_id: 'doc_rep_104',
      version_number: 2,
      sha256_hash: 'a1b2c3d4e5f60718293a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e',
      file_size: 2097152,
      created_by: 'user_inv_a',
      created_by_name: 'Inspector Preetom Saha',
      badge_number: 'SV-CYBER-704',
      change_summary: 'Integrated forensic memory card triage findings into lead report.',
    ...
    },
    {
      ...
      document_id: 'doc_rep_104',
      version_number: 1,
      sha256_hash: 'e5f6a7b8c9d0123456789abcdef0123456789abcdef0123456789abcdef01234',
      file_size: 1980000,
      created_by: 'user_inv_a',
      created_by_name: 'Inspector Preetom Saha',
      badge_number: 'SV-CYBER-704',
      change_summary: 'Draft investigation report compiled from initial seizure logs.',
...
export const MOCK_POLICE_ASSETS: PoliceAsset[] = [
  {
    id: 'ast_01',
    asset_number: 'AST-CYBER-091',
    name: 'Cellebrite UFED 4PC Mobile & Chip Extraction Terminal',
    asset_type: 'MOBILE_EXTRACTION',
    department_id: 'dept_inv',
    department_name: 'Special Anti-Cartel & Digital Forensics Wing',
    department_code: 'SDFW',
    serial_number: 'UFED-IND-2023-8821',
    assigned_officer_id: 'user_inv_a',
    assigned_officer_name: 'Inspector Preetom Saha',
    assigned_badge_number: 'SV-CYBER-704',
    status: 'INVESTIGATION_BOUND',
    current_location: 'Forensic Lab Station B-4 (Cyber Cell Sector 62)',
    related_case_id: 'case_104',
    related_case_number: 'CASE-2024-ND-412',
    related_evidence_id: 'ev_104_a',
    registered_at: '2024-01-10T10:00:00Z',
    last_inspected_at: '2024-08-10T14:30:00Z',
    assignment_history: [
      {
        id: 'ah_01',
        asset_id: 'ast_01',
        officer_id: 'user_inv_a',
        officer_name: 'Inspector Preetom Saha',
        badge_number: 'SV-CYBER-704',
        action: 'INVESTIGATION_DEPLOYMENT',
        timestamp: '2024-08-14T11:45:00Z',
        case_id: 'case_104',
        case_number: 'CASE-2024-ND-412',
        notes: 'Dispatched for forensic chip dump extraction of seized MicroSD card EV-104-A.',
      },
      {
        id: 'ah_02',
        asset_id: 'ast_01',
        officer_id: 'user_admin',
        officer_name: 'Dr. Vikramaditya Sen, IPS',
        badge_number: 'IPS-2011-DL04',
        action: 'COMMISSIONED_INTO_REGISTRY',
        timestamp: '2024-01-10T10:00:00Z',
        notes: 'Asset inducted into official cyber forensic hardware pool with certified tamper seal.',
      },
    ],
    maintenance_history: [
      {
        id: 'mh_01',
        asset_id: 'ast_01',
        maintenance_type: 'ISO-17025 Hardware Re-Calibration & Cryptographic Firmware Sync',
        performed_by: 'Cellebrite Authorized Government Engineer',
        date: '2024-06-15T11:00:00Z',
        status: 'COMPLETED',
        cost: '₹45,000 (Annual Support Contract)',
        notes: 'Hardware pass certification issued. SHA-256 test vectors validated 100%.',
      },
    ],
  },
  {
    id: 'ast_02',
    asset_number: 'AST-EOW-114',
    name: 'EnCase Forensic Acquisition & Triage Field Terminal',
    asset_type: 'FORENSIC_HARDWARE',
    department_id: 'dept_eow',
    department_name: 'Economic Offences Wing & Financial Forensics',
    department_code: 'EOW',
    serial_number: 'ENCASE-IND-2022-4412',
    assigned_officer_id: 'user_inv_b',
    assigned_officer_name: 'DSP Rajesh Nair',
    assigned_badge_number: 'EOW-DSP-218',
    status: 'ASSIGNED',
    current_location: 'EOW Operations Center Room 14',
    related_case_id: 'case_102',
    related_case_number: 'CASE-2024-EOW-102',
    registered_at: '2023-04-12T09:00:00Z',
    last_inspected_at: '2024-07-10T16:00:00Z',
    assignment_history: [
      {
        id: 'ah_03',
        asset_id: 'ast_02',
        officer_id: 'user_inv_b',
        officer_name: 'DSP Rajesh Nair',
        badge_number: 'EOW-DSP-218',
        action: 'ASSIGNED_TO_OFFICER',
        timestamp: '2023-11-20T14:30:00Z',
        case_id: 'case_102',
        case_number: 'CASE-2024-EOW-102',
        notes: 'Allocated for high-volume banking ledger forensic extraction.',
      },
    ],
    maintenance_history: [
      {
        id: 'mh_02',
        asset_id: 'ast_02',
        maintenance_type: 'Write-Blocker Controller Diagnostic & Storage Sanitization',
        performed_by: 'National Cyber Security Technical Division',
        date: '2024-07-10T16:00:00Z',
        status: 'COMPLETED',
        notes: 'Hardware write-blocker certified for zero-write evidentiary safety.',
      },
    ],
  },
  {
    id: 'ast_03',
    asset_number: 'AST-SEC-302',
    name: 'High-Security Biometric Evidence Locker Safe #4',
    asset_type: 'SECURE_STORAGE_SAFE',
    department_id: 'dept_cyber',
    department_name: 'Central Cyber Crime Investigation Cell (C3IC)',
    department_code: 'C3IC',
    serial_number: 'SAFE-BIO-2024-0091',
    assigned_officer_id: 'user_admin',
    assigned_officer_name: 'Dr. Vikramaditya Sen, IPS',
    assigned_badge_number: 'IPS-2011-DL04',
    status: 'IN_USE',
    current_location: 'Central Vault Facility Level -2, Sector 62',
    registered_at: '2024-02-01T12:00:00Z',
    last_inspected_at: '2024-08-01T10:00:00Z',
    assignment_history: [
      {
        id: 'ah_04',
        asset_id: 'ast_03',
        ...
        officer_name: 'Dr. Vikramaditya Sen, IPS',
        badge_number: 'IPS-2011-DL04',
        action: 'VAULT_CUSTODY_REGISTRATION',
        timestamp: '2024-02-01T12:00:00Z',
        notes: 'Primary depository for classified physical digital evidence media.',
      },
    ],
    maintenance_history: [
      {
        id: 'mh_03',
        asset_id: 'ast_03',
        maintenance_type: 'Dual-Custody Biometric Scanner & Key-Code Calibration',
        performed_by: 'Godrej Defense Systems Technical Team',
        date: '2024-08-01T10:00:00Z',
        status: 'COMPLETED',
        notes: 'Electromechanical interlock verified. Audit log event sync tested.',
      },
    ],
  },
  {
    id: 'ast_04',
    asset_number: 'AST-CAM-518',
    name: 'Axon Body 3 Tamper-Evident Law Enforcement Camera',
    asset_type: 'BODY_CAMERA',
    department_id: 'dept_inv',
    department_name: 'Special Anti-Cartel & Digital Forensics Wing',
    department_code: 'SDFW',
    serial_number: 'AXON-B3-IND-9912',
    assigned_officer_id: 'user_inv_a',
    assigned_officer_name: 'Inspector Preetom Saha',
    assigned_badge_number: 'SV-CYBER-704',
    status: 'IN_USE',
    current_location: 'Mobile Enforcement Kit #2',
    related_case_id: 'case_104',
    related_case_number: 'CASE-2024-ND-412',
    registered_at: '2024-03-01T08:00:00Z',
    last_inspected_at: '2024-08-15T18:00:00Z',
    assignment_history: [
      {
        id: 'ah_05',
        asset_id: 'ast_04',
        ...
        officer_name: 'Inspector Preetom Saha',
        badge_number: 'SV-CYBER-704',
        action: 'FIELD_OPERATION_DEPLOYED',
        timestamp: '2024-08-12T01:00:00Z',
        case_id: 'case_104',
        case_number: 'CASE-2024-ND-412',
        notes: 'Issued for execution of search and seizure warrant at Sector 62 workshop.',
      },
    ],
    maintenance_history: [
      {
        id: 'mh_04',
        asset_id: 'ast_04',
        maintenance_type: 'Battery Cycle Testing & Digital Signature Timestamp Verification',
        performed_by: 'Department Armoury & Tactical Equipment Desk',
        date: '2024-08-15T18:00:00Z',
        status: 'COMPLETED',
        notes: 'Firmware cryptographic attestation verified intact.',
      },
    ],
  },
  {
    id: 'ast_05',
    asset_number: 'AST-DRN-201',
    name: 'Skydio X2D Reconnaissance Tactical Thermal Drone',
    asset_type: 'SURVEILLANCE_DRONE',
    department_id: 'dept_cyber',
    department_name: 'Central Cyber Crime Investigation Cell (C3IC)',
    department_code: 'C3IC',
    serial_number: 'DRN-TACT-2024-1044',
    assigned_officer_id: 'user_admin',
    assigned_officer_name: 'Dr. Vikramaditya Sen, IPS',
    assigned_badge_number: 'IPS-2011-DL04',
    status: 'UNDER_MAINTENANCE',
    current_location: 'Central Police Aviation Hangar 3',
    registered_at: '2024-05-10T10:00:00Z',
    last_inspected_at: '2024-09-01T11:00:00Z',
    assignment_history: [
      {
        id: 'ah_06',
        asset_id: 'ast_05',
        ...
        officer_name: 'Dr. Vikramaditya Sen, IPS',
        badge_number: 'IPS-2011-DL04',
        action: 'PERIMETER_SURVEILLANCE',
        timestamp: '2024-05-15T10:00:00Z',
        notes: 'Aerial perimeter monitoring during multi-state raid operations.',
      },
    ],
    maintenance_history: [
      {
        id: 'mh_05',
        asset_id: 'ast_05',
        maintenance_type: 'Propeller Rotor Balancing & Encrypted Telemetry Diagnostic',
        performed_by: 'Skydio Certified Drone Systems Engineer',
        date: '2024-09-01T11:00:00Z',
        status: 'IN_PROGRESS',
        notes: 'Thermal camera sensor gimbal recalibration in progress.',
      },
    ],
  },
];
