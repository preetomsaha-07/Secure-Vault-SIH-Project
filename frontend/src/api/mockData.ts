...
export const MOCK_GRAPH_DATA: GraphData = {
  ...
  nodes: [
    {
      id: 'case_104',
      label: 'CASE-2026-104 (Operation Nightshade)',
      type: 'CASE',
      sensitivity: 'CONFIDENTIAL',
      details: {
        title: 'Operation Nightshade Inter-State Vehicle Racket',
        leadInvestigator: 'Inspector Preetom Saha',
        status: 'ACTIVE INVESTIGATION',
        jurisdiction: 'Special Anti-Cartel Taskforce',
    ...
    },
    {
      ...
      sensitivity: 'CONFIDENTIAL',
      details: {
        title: 'First Information Report 104/2026',
        filedBy: 'Sub-Inspector R. Sharma',
        filingDate: '2026-08-15',
        hash: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
        courtAdmissibility: 'Admitted in Special Sessions Court',
      },
    },
    {
      id: 'doc_rep_104',
      label: 'Investigation Report 104',
      type: 'DOCUMENT',
      sensitivity: 'CONFIDENTIAL',
      details: {
        classification: 'Interim Case Dossier',
        author: 'Detective Marcus Vance',
        verifiedDate: '2026-08-20',
        chainHash: 'a71b28c39de0142fa9167384bc19a82e9124fb890c29471ab48e91823746a812',
        tamperProof: 'True (Genesis Anchored)',
      },
    },
    {
      id: 'doc_for_104',
      ...
      sensitivity: 'SECRET',
      details: {
        laboratory: 'Central Forensic Science Laboratory (CFSL)',
        forensicScientist: 'Dr. Evelyn Reed, DFL',
        methodology: 'Bit-stream forensic dump & firmware carve',
        findings: 'Unencrypted GPS waypoints & telemetry recovered',
      },
    },
    {
      id: 'ev_104_a',
      label: 'MicroSD 128GB (EV-104-A)',
      type: 'EVIDENCE',
      sensitivity: 'SECRET',
      details: {
        evidenceNumber: 'EV-2026-104-A',
        storageLocker: 'Vault B / Safe 04',
        custodyOfficer: 'Officer Sarah Chen',
        forensicExtractionStatus: 'Completed & Hash-Anchored',
      },
    },
    {
      id: 'ev_104_b',
      label: '14 Embossed Number Plates (EV-104-B)',
      type: 'EVIDENCE',
      sensitivity: 'CONFIDENTIAL',
      details: {
        evidenceNumber: 'EV-2026-104-B',
        quantity: '14 Units',
        physicalCondition: 'Seized in Tamper-Proof Evidence Bag',
        manufacturingOrigin: 'Counterfeit Die Stamp Unit',
      },
    },
    {
      id: 'ent_veh_1',
      label: 'Vehicle DL-01-AB-1234',
      type: 'VEHICLE',
      details: {
        makeModel: 'Toyota Fortuner 4x4 (Matte Black)',
        engineChassis: 'Tampered / Scratched VIN',
        recoveredAt: 'Sector 62 Underground Bay 4',
        status: 'Impounded in Sector Police Compound',
      },
    },
    {
      id: 'ent_veh_2',
      label: 'Vehicle MH 12 CD 5678',
      type: 'VEHICLE',
      details: {
        makeModel: 'Hyundai Creta 1.5 SX',
        registrationStatus: 'Forged RTO Paperwork',
        linkedSuspect: 'John Doe ("Apex Vector")',
        status: 'Tracked on Highway Toll System',
      },
    },
    {
      id: 'ent_sus_1',
      label: 'John Doe ("Apex Vector")',
      type: 'PERSON',
      details: {
        alias: 'Apex Vector',
        role: 'Key Racket Coordinator & Shell Account Handler',
        warrantStatus: 'Non-Bailable Warrant Issued',
        interstateBolo: 'Active Broadcast across NCR & Maharashtra',
      },
    },
    {
      id: 'ent_loc_1',
      label: 'Sector 62 Underground Bay 4',
      type: 'LOCATION',
      details: {
        coordinates: '28.6280° N, 77.3649° E',
        siteType: 'Underground Parking Bay / Workshop',
        raidDate: '2026-08-16 03:30 AM',
        recovery: 'Seizure of tools, stamps, and hardware',
      },
    },
    {
      id: 'ent_org_1',
      ...
      type: 'ORGANIZATION',
      details: {
        agency: 'Regional Transport Office (RTO)',
        breachNotice: 'Compromised Dealer Portal Login Credentials',
        investigationLead: 'Rogue insider credentials leaked via phishing',
      },
    },
  ],
  edges: [
